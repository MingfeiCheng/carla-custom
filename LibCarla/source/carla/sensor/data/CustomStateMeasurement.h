...
namespace data {
  ...
  /// A change of Custom State Measurement.
  class CustomStateMeasurement : public SensorData {

    using Super = SensorData;

  protected:

    using Serializer = s11n::CustomStateSerializer;

    friend Serializer;

    explicit CustomStateMeasurement(const RawData &&data)
      : Super(data){
